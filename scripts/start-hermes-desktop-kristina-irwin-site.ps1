# Launch Hermes Desktop with the Kristina-Irwin-Site profile (one-click)
$ErrorActionPreference = 'Stop'

$ProfileRoot = Split-Path $PSScriptRoot -Parent
$ProfileName = 'kristina-irwin-site'
...
Write-Host "[Kristina-Irwin-Site] project-dir   -> $ProfileRoot" -ForegroundColor Cyan
Write-Host "[Kristina-Irwin-Site] active-profile -> $ProfileName" -ForegroundColor Cyan
Write-Host "[Kristina-Irwin-Site] Launching Hermes Desktop..." -ForegroundColor Green
