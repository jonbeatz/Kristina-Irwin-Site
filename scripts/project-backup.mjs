...
const REPO_ROOT = "D:\\Hermes\\projects\\Kristina-Irwin-Site";
const DEFAULT_BACKUP_ROOT = "G:\\Hermes_Project_BackUpz\\Kristina-Irwin-Site";
// Prefer single token so bootstrap kristina-irwin-site/kristina-irwin-site both resolve (1.32.3).
const BACKUP_FOLDER_BASE = "kristina-irwin-site-project";
...
async function resolveBackupPlan(rl) {
  ...
  console.log(`
+--------------------------------------------------------------+
|  Backup System — Kristina-Irwin-Site                                |
+--------------------------------------------------------------+
