...
*Last updated: 2026-08-15 · +Lightning App Mode · +Edit-2511 multi (3 images) · Hermes-Fable5 App Mode-only (`_archive`) · LMS can't load diffusion GGUFs — ComfyUI only · ComfyUI 0.31 · cu128*
