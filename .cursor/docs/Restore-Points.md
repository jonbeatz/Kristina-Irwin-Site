...
| ID | Date | Notes |
|----|------|-------|
| RP-2026-09-07-v4-start | 2026-09-07 | Cut `Kristina-Irwin-Site-Project-v4` at **4.0.0**. Frozen: `Kristina-Irwin-Site-Project-v3` @ `dd06fdd`. Pre-cut backup: `G:\Hermes_Project_BackUpz\Kristina-Irwin-Site\kristina-irwin-site-project-v1-f`. Restore v3: `git fetch origin && git checkout Kristina-Irwin-Site-Project-v3 && git reset --hard dd06fdd`. Restore v4: `git fetch --tags origin && git checkout Kristina-Irwin-Site-Project-v4 && git pull`. |
