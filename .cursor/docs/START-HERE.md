...
**Now (2026-09-07):** Active `Kristina-Irwin-Site-Project-v4` (4.0.0). Frozen v3 @ `dd06fdd`. **Live** https://kristinairwin.com — District map + college list + endorsement ticker, footer paid-for-by + MSC credit (`bdb02fd`), Involve polish, hero `KI-New-HomeBg2`. Redeploy: `site:build:static` → `siteground:deploy:clean` → **Site Tools Dynamic Cache Flush**. SSL expires **2026-09-23**.
