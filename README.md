...
[![Version](https://img.shields.io/badge/version-4.0.0-blue)](https://github.com/jonbeatz/Kristina-Irwin-Site/releases)
...
| Metric | Value |
| :--- | :--- |
| **Version** | `v4.0.0` · [Latest release](https://github.com/jonbeatz/Kristina-Irwin-Site/releases/tag/v4.0.0) |
...
| **Status** | Active `Kristina-Irwin-Site-Project-v2` · frozen v1 @ `1865e60` |
